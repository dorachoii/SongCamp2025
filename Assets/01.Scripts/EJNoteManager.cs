...
//                     {
//                         //NoteType Ȯ��
//                         if (gameNoteInstance_Rails[touchIdx][0].noteInfo.type == (int)NoteType.SHORT)
//                         {
//                             ScoreCheck_SHORT(touchIdx);
//                         }
//                         else if (gameNoteInstance_Rails[touchIdx][0].noteInfo.type == (int)NoteType.LONG && gameNoteInstance_Rails[touchIdx][0].noteInfo.isLongNoteStart)
//                         {
//                             EnterCheck_LONG(touchIdx);
//                         }
//                         else if (gameNoteInstance_Rails[touchIdx][0].noteInfo.type == (int)NoteType.DRAG_RIGHT || gameNoteInstance_Rails[touchIdx][0].noteInfo.type == (int)NoteType.DRAG_LEFT)
//                         {
...
//                                 if (gameNoteInstance_Rails[touchStartedIdx].Count > 0 &&
//                                     gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.type == (int)NoteType.DRAG_LEFT)
//                                 {
...
//                                 if (gameNoteInstance_Rails[touchStartedIdx].Count > 0 &&
//                                     gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.type == (int)NoteType.DRAG_RIGHT)
//                                 {
//                                     //print("���������� �巡�׵ǰ� �ֽ��ϴ�");
//                                     PressingScore(touchStartedIdx);
//                                     //showScoreText(10);
...
//                             if (gameNoteInstance_Rails[touchIdx][0].noteInfo.type == (int)NoteType.LONG)
//                             {
...
//                         {
//                             if (gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.type == (int)NoteType.DRAG_RIGHT || gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.type == (int)NoteType.DRAG_LEFT)
//                             {
...
//                         else
//                         {
//                             if (gameNoteInstance_Rails[touchIdx].Count > 0 && gameNoteInstance_Rails[touchIdx][0].noteInfo.type == (int)NoteType.LONG && !gameNoteInstance_Rails[touchIdx][0].noteInfo.isLongNoteStart)
//                             {
...
//         {
//             //success
//             if (touchReleasedIdx == gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.DRAG_release_idx && draggingState == DraggingState.Dragging_LEFT && gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.type == (int)NoteType.DRAG_LEFT)
//             {
//                 //success
...
//                 ScoreManager.instance.StartShowScoreText("Excellent",n,excellentScore);
//             }
//             else if (touchReleasedIdx == gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.DRAG_release_idx && draggingState == DraggingState.Dragging_RIGHT && gameNoteInstance_Rails[touchStartedIdx][0].noteInfo.type == (int)NoteType.DRAG_RIGHT)
//             {
//                 print("������ �巡�� ��Ʈ �����߾��!");
//                 PressDestroy(touchStartedIdx);
//                 //showScoreText(0);
